...
def render(out: Path, width: int, height: int):
    ...
    for name_class in names_class:
        ...
        prog["lat"].value = -30 + 60 * 0.3
        prog["lng"].value = 360 * 0.2
        prog["col1"].value = (1.0, 1.0, 1.0)
        prog["col2"].value = (1.0, 1.0, 1.0)
        prog["col3"].value = (1.0, 1.0, 1.0)
